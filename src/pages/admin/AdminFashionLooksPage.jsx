...
// API credits use { talentId, roleLabel } directly; detail responses use { talent: { id }, roleLabel }.
// Normalize both directions so the form always works with { talentId, roleLabel }.
...
export default function AdminFashionLooksPage() {
  ...
  const handleSave = async () => {
    ...
    const payload = {
      ...
      credits: form.credits.filter((credit) => credit.talentId),
      pieces: form.pieces.map((piece) => ({
        ...piece,
        credits: piece.credits.filter((credit) => credit.talentId),
      })),
          ...
          <div className="admin-modal">
            ...
            <div className="admin-modal-body">
              <div className="admin-modal-grid">
                ...
                <div className="admin-modal-field admin-modal-field-full">
                  <label className="admin-modal-label">Default Credits (designer, photographer, model, editor...)</label>
                  <CreditsField
                    value={form.credits}
                ...
                <div className="admin-modal-field admin-modal-field-full">
                  <label className="admin-modal-label">Pieces (shoppable items in this look)</label>
                  <FashionPiecesField
                    value={form.pieces}
