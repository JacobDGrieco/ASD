...
export default function AdminFashionCollectionsPage() {
  ...
  const renderDisplayValue = (collection, column) => {
    ...
    <div>
      <div className="admin-artists-page-sticky-top">
        <div className="admin-artists-page-header">
          ...
          <button onClick={openCreate} className="admin-artists-page-primary-btn">New Collection</button>
        </div>
      </div>
              ...
              >
                ...
                <td className="admin-artists-page-action-cell admin-artists-page-actions-col admin-artists-page-sticky-right-0">
                  <div className="admin-artists-page-actions">
                    <button type="button" onClick={() => void openEdit(collection)} disabled={loadingEditId === collection.id} className="admin-artists-page-ghost-btn admin-artists-page-icon-btn" aria-label="Edit collection" title="Edit">
