	...
	if (!video) {
		return (
			<div className="videos-page-player-frame videos-page-player-empty">
				<div className="videos-page-player-empty-state">
					<img src="/favicon.png" alt="" className="videos-page-player-empty-logo" />
					<p>Select an artist to watch</p>
				</div>
			</div>
		);
	}
	...
	if (error && !videos) {
		return (
			<div className="page aurora-page">
				<AuroraBackground />
				<div className="aurora-page-content videos-page-shell">
